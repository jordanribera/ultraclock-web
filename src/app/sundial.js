 ...
 * Default zenith
 */
export const ZENITH_DEFAULT = 90.8333; // sunset start
export const ZENITH_CIVIL = 96.5; // civil twilight
export const ZENITH_NAUTICAL = 102.5; // nautical twilight
export const ZENITH_ASTRONOMICAL = 108.5; // astronomical twilight
 ...
 */
export function calculate(latitude: number, longitude: number, isSunrise: boolean, zenith: number, date: Date): Date {
 ...
 */
export function getSunrise(latitude: number, longitude: number, zenith = ZENITH_DEFAULT, date = new Date()): Date {
 ...
 */
export function getSunset(latitude: number, longitude: number, zenith = ZENITH_DEFAULT, date = new Date()): Date {
